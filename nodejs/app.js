    ...
    if (req.method === 'GET') {
        ...
        switch (req.url) {
            case '/addproj.js':
                ...
                req.on('end', function () {
                    var proj = queryStr.parse(postData);
                    var insertSQL = "insert into proj(projName,projNo,note,oringinPrice) value('" + proj.projName + "','" + proj.projNo + "','" + proj.note + "','" + proj.oringinPrice + "')";
            ...
            case '/trans.js':
                ...
                req.on('end', function () {
                    var product2 = queryStr.parse(postData);
            ...
            case '/disp.js':
                ...
                req.on('end', function () {
                    var product = queryStr.parse(postData);
