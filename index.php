...
ul{ width:500px; margin:0 auto; overflow:auto; zoom:1; padding:10px;}
ul li{ float:left;margin-left:20px; display:inline;  overflow:hidden;}
</style>
  </head>
...
<div> 
  ...
  <div class="form-group" style="width:250px;height:300px">
                ...
                <select name="netlist" id="netlist" style="height:200px;width:150px;margin:20px" size="10" class="form-control"  onchange= "GetProData(this.options[this.options.selectedIndex].value)">
                  <?php 
	                  $result=getPidList();
